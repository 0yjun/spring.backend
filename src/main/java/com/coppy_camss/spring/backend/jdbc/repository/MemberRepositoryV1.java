...
public class MemberRepositoryV1 {
    ...
    public MemberRepositoryV1(HikariDataSource dataSource) {
        log.info("datasource is ps {} name {} url {}",dataSource.getPassword(),dataSource.getUsername(),dataSource.getJdbcUrl());
